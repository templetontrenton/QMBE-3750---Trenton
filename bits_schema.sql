...
#Question 3
SELECT WorkOrders.OrderNum
FROM WorkOrders
JOIN Client ON WorkOrders.ClientNum = Client.ClientNum
WHERE WorkOrders.OrderDate = '2018-09-10' AND Client.ClientNum = '322';
...
#Question 7
SELECT SUM(Client.Balance) AS TotalBalance
FROM Consultant
JOIN Client ON Consultant.ConsltNum = Client.ConsltNum
